...
const HU: LandingContent = {
  ...
  pricing: {
    ...
    subline: "Bármikor lemondható · Minden csomag tartalmaz alaprajz-szerkesztőt, jegyboltot és QR-kódos beengedést",
    ...
    plans: [
      {
        ...
        period: "/hó",
        desc: "A kezdéshez",
        features: ["5 esemény/hó", "Max. 150 férőhely", "Alaprajz-szerkesztő", "E-mail jegyek & QR-kód"],
        highlight: false,
      },
      {
        name: "Pro",
      ...
      },
      {
        ...
        price: "€149",
        period: "/hó",
        desc: "Nagyobb helyszíneknek",
        features: [
          "Korlátlan esemény és férőhely",
          "Többnyelvű foglalási oldal",
          "Több felhasználó",
          "API-hozzáférés",
