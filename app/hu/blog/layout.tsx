      ...
      <footer className="border-t border-border py-8 mt-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex gap-5">
            <Link href="/agb" className="hover:text-foreground transition-colors">ÁSZF</Link>
            <Link href="/datenschutz" className="hover:text-foreground transition-colors">Adatvédelem</Link>
            <Link href="/impressum" className="hover:text-foreground transition-colors">Impresszum</Link>
          </div>
