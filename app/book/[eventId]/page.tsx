      ...
      <footer className="border-t border-border bg-background mt-10">
        <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <Link href="/imprint" className="hover:text-foreground transition-colors">{strings.impressum}</Link>
            <Link href="/privacy" className="hover:text-foreground transition-colors">{strings.datenschutz}</Link>
            <Link href="/terms" className="hover:text-foreground transition-colors">{strings.agbFooter}</Link>
          </div>
        </div>
      </footer>
    </div>
